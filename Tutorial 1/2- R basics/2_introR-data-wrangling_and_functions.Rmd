...
#### Please submit the R codes and results in a .txt file
...
<u>**Exercise 1)**</u> Write a function that takes a path to a file as string(in this exercise to "GSE71562.csv"). [Row and columns are genes and columns, respectively]


***First***), take the average of the samples for each gene and find the name of the gene with the highest value

***Second***) print the number and names of genes whose values are greater than 2 * SD (standard deviation) of the its average value
